...
TRUNCATE TABLE DEPARTMENT;  -- ERROR : 제약조건이 있어서 삭제 안됨
...
DISABLE CONSTRAINTS FK_MGRID;  -- DDL 구문 실행 : 새 트랜잭션 시작됨
...
ROLLBACK TO S2; -- SAVEPOINT S2 까지 취소
SELECT * FROM EMPLOYEE;

--SELECT CONSTRAINT_NAME, TABLE_NAME
--FROM USER_CONSTRAINTS
--WHERE CONSTRAINT_NAME = 'SYS_C007665';
--
...
COMMIT; -- COMMIT 하기 전까지는 다른 SQL에서 볼수가 없음